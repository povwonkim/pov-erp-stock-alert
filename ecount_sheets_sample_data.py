...
SAMPLE_ROWS = {
    "관리팀_전체재고": [
        ...
        ["POV Atelier", "POV-1002", "레더 펜슬캡 · 네이비", "자체제작", "⚠️ 주의", 35, 3, 2, 1, 1, 7, 8, 0, 1, 1, 49, "제작 검토", ""],
        ["국내OEM", "DM-4001", "라벨 스티커 A4", "국내사입", "🔴‼️ 초과주문", 7, -2, 0, 0, 0, -2, 0, 0, 0, 12, "", "재고 데이터 즉시 확인", "이카운트 전표 확인 필요"],
    ...
    "디자인팀_발주필요": [
        # 브랜드, 품목코드, 품목명, 조달유형, 상태, 우선순위, 리드타임(일), 재고수량, DOI, 최근7일, 최근90일, 품절경과일, 조치방안, 메모
        ["POV_original", "POV-1001", "오브제 노트 A5 · 크림", "자체제작", "🚨 위험", 1, 35, 1, 7, 1, 9, "", "긴급 제작 필요", ""],
        ["POV Atelier", "POV-1002", "레더 펜슬캡 · 네이비", "자체제작", "⚠️ 주의", 2, 35, 7, 49, 1, 12, "", "제작 검토", ""],
