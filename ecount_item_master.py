...
# POP-UP(2026-08-07 확인): 팝업 행사 때 업체(타사) 물건을 대신 판매하려고 등록한 것 —
# POV 소유 자산이 아니라서 재고 추적 대상 자체가 아님.
EXCLUDED_BRANDS = {"ARCHIVE. Object", "PointofView", "POP-UP"}

# 더는 POV가 취급하지 않는 옛 브랜드(전신 시절 브랜드 등) — 재고를 완전히 폐기/정리했어야
# 하는데 몇 년째 방치된 진짜 "썩은 자산"(2026-08-07 사용자 확인). EXCLUDED_BRANDS와 다르게
# 완전히 무시하지 않는다 — RAW_품목마스터엔 기록으로 남기고, 재고가 1개라도 있으면
