...
TABS: dict[str, list[str]] = {
    ...
    "일별변동계산": [
        ...
        "최근7일판매량", "최근60일판매량", "DOI", "상태", "품절경과일", "우선순위",
    ],
    # 3층 결과물 (용도별 뷰) — 온라인의 "위험/주의/재고소량·판매없음/신규품절/지속품절" 리스트에 대응.
    # 정렬: 위험·주의는 DOI 오름차순, 품절-지속/장기는 최근60일판매량 내림차순(부활가치 큰 것 우선).
    "디자인팀_발주필요": [
        "우선순위", "상태", "브랜드", "품목코드", "품목명", "재고수량", "DOI",
        "최근7일판매량", "최근60일판매량", "품절경과일", "조치방안", "메모", "업데이트일시",
    ],
    "관리팀_전체재고": [
    ...
    # 품절-장기 중에서도 최근60일판매량=0(부활가치 없음)인 것만. 판매량 있는 장기품절은
    # 디자인팀_발주필요의 "재입고 골든타임"으로 남긴다. 재발주/제작/단종 최종 판단용.
    "악성품절": [
        "브랜드", "품목코드", "품목명", "재고수량", "최근판매일", "미판매경과일",
        "최근입고일", "미입고경과일", "최근60일판매량", "조치방안", "메모",
    ],
}
